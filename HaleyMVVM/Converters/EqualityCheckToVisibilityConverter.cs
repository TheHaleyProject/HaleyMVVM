...
{
    public sealed class EqualityCheckToVisibilityConverter : IValueConverter //Can be used to check if the input parameter and the binded value are similar. Both should match integer.
    {
